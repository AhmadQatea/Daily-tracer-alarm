...
<div class="time-card mt-5">
    <form method="POST" action="/alarms/create" onsubmit="return validateForm()">
        @csrf

        <div class="row mb-3">
            <label for="bedtime" class="col-md-4 col-form-label text-md-end">{{ __('Bedtime') }}</label>
            <div class="col-md-6">
                <input id="bedtime" type="time" class="form-control @error('bedtime') is-invalid @enderror" name="bedtime" value="{{ old('bedtime') }}" required>
                @error('bedtime')
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <input id="wake_up_time" type="time" class="form-control @error('wake_up_time') is-invalid @enderror" name="wake_up_time" value="{{ old('wake_up_time') }}" required>
                @error('wake_up_time')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
